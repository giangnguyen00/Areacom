...
describe('Contract CRUD tests', function() {
	...
	it('should be able to save Contract instance if not logged in. (Did not add security yet)', function(done) {
		agent.post('/contracts')
			.send(contract)
			.expect(200)
			.end(function(contractSaveErr, contractSaveRes) {
    ...
    it('should not be able to save Contract instance if start date is not provided', function(done) {
        // Invalidate name field
        contract.StartDate = '';
        ...
        agent.post('/auth/signin')
            ...
            .end(function(signinErr, signinRes) {
                ...
                agent.post('/contracts')
                    ...
                    .end(function(contractSaveErr, contractSaveRes) {
                        // Set message assertion
                        (contractSaveRes.body.message).should.match('Please add start date for the contract');
    ...
    it('should not be able to save Contract instance if Tower Cloud Site ID is not provided', function(done) {
        // Invalidate name field
        contract.tcsiteID = '';
        ...
        agent.post('/auth/signin')
            ...
            .end(function(signinErr, signinRes) {
                ...
                agent.post('/contracts')
                    ...
                    .end(function(contractSaveErr, contractSaveRes) {
                        // Set message assertion
                        (contractSaveRes.body.message).should.match('Please add a Tower Cloud Site ID');
    ...
    it('should not be able to save Contract instance if Tower Owner Site ID is not provided', function(done) {
        // Invalidate name field
        contract.tositeID = '';
        ...
        agent.post('/auth/signin')
            ...
            .end(function(signinErr, signinRes) {
                ...
                agent.post('/contracts')
                    ...
                    .end(function(contractSaveErr, contractSaveRes) {
                        // Set message assertion
                        (contractSaveRes.body.message).should.match('Please add a Tower Owner Site ID');
